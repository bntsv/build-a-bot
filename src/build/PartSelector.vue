...
const props = defineProps({
  ...
  position: { type: String, required: true, validator(value) { return ["left", "right", "center", "top", "bottom"].includes(value); } },
});
const emits = defineEmits("partSelected");
const selectedPartIndex = ref(0);
const selectedPart = computed(() => props.parts[selectedPartIndex.value]);
emits("partSelected", selectedPart);
